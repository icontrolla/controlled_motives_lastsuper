    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft_metadata', models.JSONField(blank=True, help_text='Metadata of the NFT', null=True)),
                ('copyright_hash', models.CharField(blank=True, max_length=255, null=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conceptual_mixed_media_created', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft_metadata', models.JSONField(blank=True, help_text='Metadata of the NFT', null=True)),
                ('copyright_hash', models.CharField(blank=True, max_length=255, null=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fashionarts_created', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fashionarts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artwork', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.fineart')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft_metadata', models.JSONField(blank=True, help_text='Metadata of the NFT', null=True)),
                ('copyright_hash', models.CharField(blank=True, max_length=255, null=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='virtualinteractivearts_created', to=settings.AUTH_USER_MODEL)),
